...
> [completion record](../tasks/T009c.md). T009a/T009c and T009b's `crpgc
> replay` wrapper are merged on `master` as of 2026-09-07; T010 is next.
...
- 2026-09-07 (UTC) · opencode/big-pickle + T009b merged · Updated the active supersession note to the merged `crpgc replay` wrapper; T010 is next.
